...
with col1:
    ...
    sbp = st.number_input("Systolic Blood Pressure (mmHg) *")    st.caption("Value must be between 90 - 200")    st.caption("Value must be between 90 - 200")
    dbp = st.number_input("Diastolic Blood Pressure (mmHg) *")    st.caption("Value must be between 60 - 130")    st.caption("Value must be between 60 - 130")
    
with col2:
    total_cholesterol = st.number_input("Total Cholesterol (mg/dL) *")    st.caption("Value must be between 130 - 320")    st.caption("Value must be between 130 - 320")
    ldl = st.number_input("LDL Cholesterol (mg/dL) *")    st.caption("Value must be between 30 - 300")    st.caption("Value must be between 30 - 300")
    hdl = st.number_input("HDL Cholesterol (mg/dL) *")    st.caption("Value must be between 20 - 100")    st.caption("Value must be between 20 - 100")
    triglycerides = st.number_input("Triglycerides (mg/dL) *")    st.caption("Value must be between 50 - 400")    st.caption("Value must be between 50 - 400")
    
with col3:
    heart_rate = st.number_input("Heart Rate (BPM) *")    st.caption("Value must be between 40 - 120")    st.caption("Value must be between 40 - 120")
    resting_hr = st.number_input("Resting Heart Rate (BPM) *")    st.caption("Value must be between 40 - 100")    st.caption("Value must be between 40 - 100")
    hrv = st.number_input("HRV (Heart Rate Variability) *")    st.caption("Value must be between 10 - 100")    st.caption("Value must be between 10 - 100")
